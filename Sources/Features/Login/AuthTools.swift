...
class AuthenticationManager: ObservableObject {
	...
	func googleLogin() {
		...
		let googleSign = GIDSignIn.sharedInstance

		googleSign.configuration = GIDConfiguration(clientID: FirebaseApp.app()?.options.clientID ?? "")
		googleSign.signIn(withPresenting: viewController) { result, error in
