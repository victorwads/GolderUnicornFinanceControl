...
Rules:
- When you finish all actions requested by the user, you should call the ${ToUserTool.ONBOARDING_COMPLETE} tool to end the session. Please confirm with the user that all actions were completed.
- Do not call ${ToUserTool.ONBOARDING_COMPLETE} before finishing all orchestration required by the user.
