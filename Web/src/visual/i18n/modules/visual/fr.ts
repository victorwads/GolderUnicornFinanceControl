  ...
  visual: {
    ...
    settings: {
      ...
      developer: {
        ...
        localDataDescription: "Réinitialise les préférences et caches enregistrés dans ce navigateur.",
        clearVisualSettings: "Clear visual settings",
        clearUserSettings: "Clear user settings",
        clearAllLocalSettings: "Clear all local data",
        localDataHint: "These actions remove localStorage/sessionStorage keys and reload the page.",
        onboardingTitle: "Onboarding",
        onboardingDescription: "Controls whether new assistant conversations start in the onboarding flow.",
        assistantOnboardingToggle: "Enable assistant onboarding",
        assistantOnboardingToggleDescription: "The current state is loaded from Firebase and the page reloads after changes.",
        assistantOnboardingLoading: "Loading onboarding state from Firebase...",
    ...
    privacy: {
      ...
      exportActionTitle: "Export my data",
      exportActionDescription: "Choose the format and optionally protect the ZIP with a password",
      exportFormatTitle: "File format",
      exportPasswordToggleTitle: "Protect ZIP with password",
      exportPasswordToggleDescription: "Requires a password to open the exported file",
      exportPasswordFieldTitle: "ZIP password",
      exportPasswordFieldPlaceholder: "Enter a password for the file",
      exportCsvTitle: "Export as CSV",
      exportCsvDescription: "Compatible with Excel and spreadsheets",
      exportHint: "Exported data includes your transactions, accounts, cards, categories, etc. Your data belongs to you and can be exported at any time.",
      ...
      downloadEncryptionKeyTitle: "Download my encryption key",
      downloadEncryptionKeyDescription: "Saves a file on this device with the key used to unlock your data",
      downloadEncryptionKeySuccessDescription: "Your encryption key was downloaded successfully.",
      downloadEncryptionKeyErrorTitle: "Failed to download key",
      downloadEncryptionKeyErrorDescription: "Could not download your encryption key.",
    ...
    assistant: {
      ...
      monthlyBudgetLabel: "Budget mensuel (30 derniers jours)",
      monthlyBudgetDescription: "Dépense de l'assistant sur les 30 derniers jours par rapport à la limite fixe de 5 BRL.",
