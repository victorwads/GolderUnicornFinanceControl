...
const fr: VisualModuleTranslation = {
  visual: {
    ...
    privacy: {
      ...
      exportEncryptedJsonTitle: "Export encrypted JSON",
      exportEncryptedJsonDescription: "Copies the documents in the encrypted format stored in Firebase",
      ...
      importPasswordRequiredTitle: "Encrypted file detected",
      importPasswordRequiredDescription: (count: number) => `${count} file(s) require the encryption password before import.`,
      importPasswordDialogTitle: "Unlock import",
      importPasswordDialogDescription: "This backup was exported in encrypted format. Enter the password to decrypt it before importing.",
      importPasswordDialogPlaceholder: "Enter the encryption password",
      importPasswordDialogCancel: "Cancel",
      importPasswordDialogConfirm: "Import",
