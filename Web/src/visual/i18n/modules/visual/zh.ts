  ...
  visual: {
    ...
    settings: {
      ...
      developer: {
        ...
        localDataTitle: "本地数据",
        localDataDescription: "重置当前浏览器中保存的偏好和缓存。",
    ...
    privacy: {
      ...
      exportActionTitle: "导出我的数据",
      exportActionDescription: "选择文件格式，并可选择是否用密码保护 ZIP",
      exportFormatTitle: "文件格式",
      exportPasswordToggleTitle: "用密码保护 ZIP",
      exportPasswordToggleDescription: "打开导出的文件时需要输入密码",
      exportPasswordFieldTitle: "ZIP 密码",
      exportPasswordFieldPlaceholder: "输入文件密码",
      exportCsvTitle: "导出为 CSV",
      exportCsvDescription: "兼容 Excel 和电子表格",
      exportHint: "导出的数据包括你的交易、账户、卡片、分类等。数据属于你自己，你可以随时导出。",
      ...
      downloadEncryptionKeyTitle: "下载我的加密密钥",
      downloadEncryptionKeyDescription: "在此设备上保存一个用于解锁你数据的密钥文件",
      downloadEncryptionKeySuccessDescription: "你的加密密钥已成功下载。",
      downloadEncryptionKeyErrorTitle: "下载密钥失败",
      downloadEncryptionKeyErrorDescription: "无法下载你的加密密钥。",
    ...
    assistant: {
      ...
      monthlyBudgetLabel: "月度预算（最近 30 天）",
      monthlyBudgetDescription: "助手最近 30 天的花费，相对于固定的 5 BRL 上限。",
