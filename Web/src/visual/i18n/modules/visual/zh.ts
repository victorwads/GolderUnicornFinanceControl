...
const zh: VisualModuleTranslation = {
  visual: {
    ...
    privacy: {
      ...
      exportEncryptedJsonTitle: "导出加密 JSON",
      exportEncryptedJsonDescription: "按 Firebase 中保存的加密格式复制文档",
      ...
      importPasswordRequiredTitle: "检测到加密文件",
      importPasswordRequiredDescription: (count: number) => `${count} 个文件在导入前需要加密密码。`,
      importPasswordDialogTitle: "解锁导入",
      importPasswordDialogDescription: "这个备份以加密格式导出。请输入密码，先解密再导入。",
      importPasswordDialogPlaceholder: "输入加密密码",
      importPasswordDialogCancel: "取消",
      importPasswordDialogConfirm: "导入",
