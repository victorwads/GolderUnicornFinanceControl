  ...
  visual: {
    ...
    settings: {
      ...
      developer: {
        ...
        localDataDescription: "Resets preferences and caches stored in this browser.",
    ...
    assistant: {
      ...
      monthlyBudgetLabel: "Monthly budget (last 30 days)",
      monthlyBudgetDescription: "Assistant spending in the last 30 days against the fixed BRL 5 limit.",
