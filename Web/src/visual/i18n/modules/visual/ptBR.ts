...
const ptBR: VisualModuleTranslation = {
  visual: {
    ...
    privacy: {
      ...
      exportEncryptedJsonTitle: "Exportar JSON criptografado",
      exportEncryptedJsonDescription: "Copia os documentos no formato criptografado salvo no Firebase",
      ...
      importPasswordRequiredTitle: "Arquivo criptografado detectado",
      importPasswordRequiredDescription: (count: number) => `${count} arquivo(s) precisam da senha de criptografia para importar.`,
      importPasswordDialogTitle: "Desbloquear importação",
      importPasswordDialogDescription: "Esse backup foi exportado no formato criptografado. Informe a senha para descriptografar antes de importar.",
      importPasswordDialogPlaceholder: "Digite a senha de criptografia",
      importPasswordDialogCancel: "Cancelar",
      importPasswordDialogConfirm: "Importar",
