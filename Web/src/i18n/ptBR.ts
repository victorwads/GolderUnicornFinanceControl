...
const ptBR: Translation = {
  ...
  timeline: {
    ...
    importOfxAccountOption: 'Conta bancária',
    importOfxCreditOption: 'Cartão de crédito',
    importOfxAccountLabel: 'Conta para lançar',
    importOfxCardLabel: 'Cartão para lançar',
    importOfxFileLabel: 'Arquivo OFX',
    importOfxLoaded: (count: number) => `${count} lançamentos carregados`,
    importOfxNoTransactions: 'Nenhuma transação encontrada no arquivo.',
    importOfxImport: 'Importar',
    importOfxError: 'Não foi possível processar o arquivo OFX.',
    importOfxSuccess: 'Lançamentos importados com sucesso.',
  },
  registry: {
    title: 'Registro',
  ...
  settings: {
    ...
    deleteDataSuccess: 'Sua solicitação de exclusão foi enviada. Você será desconectado agora.',
    deleteDataError: 'Não foi possível enviar a solicitação de exclusão. Tente novamente.',
    deleteDataPhrases: () => [
    ...
    deleteDataFinalizing: 'Finalizando a exclusão dos seus dados...',
    auth: 'Autenticação',
    logout: 'Sair',
    ...
    timelineModeStart: (day) => `Nome do mês atual ao dia ${day}`,
    timelineModeNext: (day) => `Nome do próximo mês depois do dia ${day}`,
