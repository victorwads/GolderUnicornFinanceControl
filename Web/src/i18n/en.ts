...
const en: Translation = {
  ...
  settings: {
    ...
    deleteDataSuccess: 'Your deletion request was submitted. You will be signed out now.',
    deleteDataError: 'We could not send the data deletion request. Please try again.',
    deleteDataPhrases: () => [
    ...
    deleteDataFinalizing: 'Finalizing your data deletion...',
    auth: 'Auth',
    logout: 'Logout',
