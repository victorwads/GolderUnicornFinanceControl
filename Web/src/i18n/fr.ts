...
const fr: Translation = {
  ...
  settings: {
    ...
    deleteDataPrompt: (phrase: string) => `Saisissez « ${phrase} » pour confirmer.`,
    deleteDataMismatch: "La phrase saisie ne correspond pas. Rien n'a été supprimé.",
    deleteDataSuccess: 'Votre demande de suppression a été envoyée. Vous allez être déconnecté maintenant.',
    deleteDataError: "Impossible d'envoyer la demande de suppression. Réessayez.",
    deleteDataPhrases: () => [
      "J'accepte de supprimer toutes mes données",
      'Je veux effacer définitivement mes données',
      'Je comprends que cette action est irréversible',
      'Je souhaite retirer tout ce qui concerne mon compte',
      'Oui, supprime maintenant toutes mes données',
    ],
    deleteDataFinalizing: 'Finalisation de la suppression de vos données...',
