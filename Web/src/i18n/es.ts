...
const es: Translation = {
  ...
  settings: {
    ...
    deleteDataSuccess: 'Tu solicitud de eliminación fue enviada. Tu sesión se cerrará ahora.',
    deleteDataError: 'No pudimos enviar la solicitud de eliminación. Inténtalo de nuevo.',
    deleteDataPhrases: () => [
    ...
    deleteDataFinalizing: 'Finalizando la eliminación de tus datos...',
    auth: 'Autenticación',
